...
map<string, ShipDetails*> Ships::details {
	...
	{Factions::faction2, new ShipDetails(220, 50, 40, sf::Vector2f({.02, .02}), sf::Vector2f({.02, .02}), .2)},
	{Factions::faction3, new ShipDetails(220, 50, 40, sf::Vector2f({.02, .02}), sf::Vector2f({.02, .02}), .2)},
